...
namespace gl3
{
    ...
    Text::~Text()
    {
        ...
        if(_font)
            TTF_CloseFont(_font); // Attention! Cela ferme aussi les font d'origines qui sont passées à l'objet! Supprimez vos objets avec le même delete !
        _font = NULL;
